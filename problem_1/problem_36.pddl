(define (problem spot_problem_36)
  (:domain simple)
...
(:init
  ...
  (door_blocked r40f0)
  (door_blocked r41f0)
  (person_detected p10 r41f0)
  (door_closed r42f0)
  (door_notchecked r43f0)
  (person_detected p11 r43f0)
  (door_notchecked r44f0)
  (person_detected p12 r44f0)
)
